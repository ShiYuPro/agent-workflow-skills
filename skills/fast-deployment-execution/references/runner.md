...
```sh
python3 skills/fast-deployment-execution/scripts/deploy_runner.py check skills/fast-deployment-execution/scripts/release-plan.example.json
python3 -m unittest discover -s skills/fast-deployment-execution/scripts -p 'test_*.py'
```
